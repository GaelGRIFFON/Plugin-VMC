...
function updateDisplayPlugin(_callback) {
    $.ajax({
        type: "POST",
        url: "plugins/vmc/core/ajax/vmc.ajax.php", // ne pas oublier de modifier pour le nom de votre plugin
        data: {
            action: "getAll"
        },
        dataType: 'json',
        ...
        success: function (data) {
            ...
            for (var i  in eqLogics) {
                ...
                htmlContainer += '<img src="plugins/vmc/doc/images/vmc_icon.png" height="105" width="95" />';
                htmlContainer += "</center>";
